...
export const routes: SiteRoute[] = [
  ...
  { path: "/about/",        label: "about/",        description: "what quirgs is", group: "site",     primary: true },
  { path: "/bundles/",      label: "bundles/",      description: "skill bundles",          group: "registry" },
  { path: "/demo/",         label: "demo/",         description: "HITL Gate demo",   group: "resources", primary: true },
  ...
  { path: "/hitl/",         label: "hitl/",         description: "human approval queue",   group: "resources" },
  { path: "/review/",       label: "review/",       description: "HITL gate review queue", group: "resources" }, 
  { path: "/resources/",    label: "resources/",    description: "case studies & writeups", group: "docs" },
  ...
  { path: "/security/",     label: "security/",     description: "security & trust posture", group: "site" },
