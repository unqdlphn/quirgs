...
Every response this skill produces — including clarifying questions, brief
decodes, catalog match results (including hard-stop exclusions), and any
output that is not the final pitch document — must end with this line:

> ⚠️ *Advisory only — this is not a legal license agreement; formalize terms through a sync licensing agreement.*

The full boxed ADVISORY NOTICE on the Final Pitch Document (Step 3b) replaces
this short line only when that complete document is emitted.
...
Compile the pitches into a single submission document, preceded by:

```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
⚠️ ADVISORY NOTICE
This output is generated by an AI skill for administrative support purposes
only. It does not constitute a legal license agreement. All license terms —
fees, exclusivity, territory, term — must be formalized through a signed sync
licensing agreement before use.
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```

Offer to save as `.md` or format as a ready-to-send email.
